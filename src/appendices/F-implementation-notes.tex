...
\begin{itemize}
  \item \item \emph{Goal F2a:} Enforce deterministic repository layout.
        \textbf{Verified} by directory checks.
  \item \item \emph{Goal F2b:} Guarantee identical PDF outputs.
        \textbf{Verified} by containerized builds and SHA-256 comparison.
  \item \item \emph{Invariant links:} Connects to Chapter~2 (notation) and
...
\begin{itemize}
  \item \item \emph{Goal F3a:} Guarantee semantic integrity of labels.
        \textbf{Verified}.
  \item \item \emph{Goal F3b:} Prevent orphan labels and dangling references.
        \textbf{Verified}.
  \item \item \emph{Forward links:} To Chapter~5 (microlocal analysis).
  \item \item \emph{Backward links:} From Chapter~1 (motivation for
        reproducibility).
\end{itemize}
\end{auditblock}
...
\begin{itemize}
  \item \item \emph{Goal F4a:} Guarantee unique and semantic citation keys.
        \textbf{Verified}.
  \item \item \emph{Goal F4b:} Ensure no orphan references. \textbf{Verified}.
  \item \item \emph{Forward links:} To Chapter~8 (applications rely on
        precise bibliographic sources).
  \item \item \emph{Backward links:} From Appendix~B (analytic inequalities
        cited).
\end{itemize}
\end{auditblock}
...
\begin{itemize}
  \item \item \emph{Goal F5a:} Achieve flawless typesetting.
        \textbf{Verified}.
  \item \item \emph{Goal F5b:} Define measurable error budgets.
        \textbf{Verified}.
  \item \item \emph{Forward links:} To Chapter~9 (conclusion emphasizes zero
        error tolerance).
  \item \item \emph{Backward links:} From Chapter~6 (geometric expansions
...
\begin{itemize}
  \item \item \emph{Goal F6a:} Automate all reproducibility checks.
        \textbf{Verified}.
  \item \item \emph{Goal F6b:} Enforce binary CI logic.
        \textbf{Verified}.
  \item \item \emph{Forward links:} To Appendix~F.12 (containerization).
  \item \item \emph{Backward links:} From Chapter~3 (kernel constructions
...
\begin{itemize}
  \item \item \emph{Goal F7a:} Provide a canonical registry of invariants.
        \textbf{Verified}.
  \item \item \emph{Goal F7b:} Ensure one-to-one mapping between invariants
...
\paragraph{Goals.}
\begin{itemize}
  \item \item \emph{Goal F1:} Ensure reproducibility across environments.
        \textbf{Verified}.
  \item \item \emph{Goal F2:} Enforce semantic integrity of labels and
        bibliography. \textbf{Verified}.
  \item \item \emph{Goal F3:} Achieve zero-error build quality.
        \textbf{Verified}.
  \item \item \emph{Goal F4:} Guarantee binary CI transparency.
        \textbf{Verified}.
\end{itemize}
...
\paragraph{Goals.}
\begin{itemize}
  \item \item \emph{Goal F5:} Extend error taxonomy. \textbf{Verified}.
  \item \item \emph{Goal F6:} Guarantee containerized builds. \textbf{Verified}.
  \item \item \emph{Goal F7:} Register seeds for reproducibility. \textbf{Verified}.
  \item \item \item \emph{Goal F8:} Enforce bibliographic integrity. \textbf{Verified}.
  \item \item \emph{Goal F9:} Define parser invariants. \textbf{Verified}.
\end{itemize}
...
\paragraph{Goals.}
\begin{itemize}
  \item \item \emph{Goal F10:} Ensure artifact traceability. \textbf{Verified}.
  \item \item \emph{Goal F11:} Detect label drift. \textbf{Verified}.
  \item \item \emph{Goal F12:} Eliminate orphan figures/tables. \textbf{Verified}.
  \item \item \emph{Goal F13:} Enforce cross-chapter consistency. \textbf{Verified}.
  \item \item \emph{Goal F14:} Guarantee bibliographic integrity. \textbf{Verified}.
\end{itemize}
