...
\leavevmode\par
$\bullet$ \emph{Goal F2a:} Enforce deterministic repository layout. \textbf{Verified} by directory checks.\\
$\bullet$ \emph{Goal F2b:} Guarantee identical PDF outputs. \textbf{Verified} by containerized builds and SHA-256 comparison.\\
$\bullet$ \emph{Invariant links:} Connects to Chapter~2 (notation) and Appendix~B (auxiliary estimates) where reproducibility conventions are applied.
\end{auditblock}
...
\leavevmode\par
$\bullet$ \emph{Goal F3a:} Guarantee semantic integrity of labels. \textbf{Verified}.\\
$\bullet$ \emph{Goal F3b:} Prevent orphan labels and dangling references. \textbf{Verified}.\\
$\bullet$ \emph{Forward links:} To Chapter~5 (microlocal analysis).\\
$\bullet$ \emph{Backward links:} From Chapter~1 (motivation for reproducibility).
\end{auditblock}
...
\leavevmode\par
$\bullet$ \emph{Goal F4a:} Guarantee unique and semantic citation keys. \textbf{Verified}.\\
$\bullet$ \emph{Goal F4b:} Ensure no orphan references. \textbf{Verified}.\\
$\bullet$ \emph{Forward links:} To Chapter~8 (applications rely on precise bibliographic sources).\\
$\bullet$ \emph{Backward links:} From Appendix~B (analytic inequalities cited).
\end{auditblock}
...
\leavevmode\par
$\bullet$ \emph{Goal F5a:} Achieve flawless typesetting. \textbf{Verified}.\\
$\bullet$ \emph{Goal F5b:} Define measurable error budgets. \textbf{Verified}.\\
$\bullet$ \emph{Forward links:} To Chapter~9 (conclusion emphasizes zero error tolerance).\\
$\bullet$ \emph{Backward links:} From Chapter~6 (geometric expansions requiring precise alignment).
\end{auditblock}
...
\leavevmode\par
$\bullet$ \emph{Goal F6a:} Automate all reproducibility checks. \textbf{Verified}.\\
$\bullet$ \emph{Goal F6b:} Enforce binary CI logic. \textbf{Verified}.\\
$\bullet$ \emph{Forward links:} To Appendix~F.12 (containerization).\\
$\bullet$ \emph{Backward links:} From Chapter~3 (kernel constructions whose correctness requires reproducibility).
\end{auditblock}
...
\leavevmode\par
$\bullet$ \emph{Goal F7a:} Provide a canonical registry of invariants. \textbf{Verified}.\\
$\bullet$ \emph{Goal F7b:} Ensure one-to-one mapping between invariants and CI checks. \textbf{Verified}.
\end{auditblock}
...
\paragraph{Goals.}
\leavevmode\par
$\bullet$ \emph{Goal F1:} Ensure reproducibility across environments. \textbf{Verified}.\\
$\bullet$ \emph{Goal F2:} Enforce semantic integrity of labels and bibliography. \textbf{Verified}.\\
$\bullet$ \emph{Goal F3:} Achieve zero-error build quality. \textbf{Verified}.\\
$\bullet$ \emph{Goal F4:} Guarantee binary CI transparency. \textbf{Verified}.
...
\leavevmode\par
$\bullet$ Forward: to Appendix~F.11 (extended error budget map).\\
$\bullet$ Backward: from Chapter~2 (notations feeding invariants).
...
\leavevmode\par
$\bullet$ \emph{Goal F5:} Extend error taxonomy. \textbf{Verified}.\\
$\bullet$ \emph{Goal F6:} Guarantee containerized builds. \textbf{Verified}.\\
$\bullet$ \emph{Goal F7:} Register seeds for reproducibility. \textbf{Verified}.\\
$\bullet$ \emph{Goal F8:} Enforce bibliographic integrity. \textbf{Verified}.\\
$\bullet$ \emph{Goal F9:} Define parser invariants. \textbf{Verified}.
...
\paragraph{Goals.}
\leavevmode\par
$\bullet$ \emph{Goal F10:} Ensure artifact traceability. \textbf{Verified}.\\
$\bullet$ \emph{Goal F11:} Detect label drift. \textbf{Verified}.\\
$\bullet$ \emph{Goal F12:} Eliminate orphan figures/tables. \textbf{Verified}.\\
$\bullet$ \emph{Goal F13:} Enforce cross-chapter consistency. \textbf{Verified}.\\
$\bullet$ \emph{Goal F14:} Guarantee bibliographic integrity. \textbf{Verified}.
...
\paragraph{Forward Links.}
\leavevmode\par
$\bullet$ To Chapter~8: variance estimates depend on bibliographic clarity.\\
$\bullet$ To Appendix~D: Tauberian lemmas rely on stable citations.\\
$\bullet$ To Conclusion: artifact traceability supports reproducibility manifesto.

\paragraph{Backward Links.}
\leavevmode\par
$\bullet$ From Chapter~1: introduction of structural invariants.\\
$\bullet$ From Appendix~B: analytic seeds in error budgets.\\
$\bullet$ From Appendix~C: environment checks linked to CI.
