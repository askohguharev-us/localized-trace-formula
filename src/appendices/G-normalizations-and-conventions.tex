% ==================================================================
% G-normalizations-and-conventions.tex — Appendix G (Diamond Standard)
% ==================================================================

\section{Normalizations and Conventions}\label{appG:root}
...
\begin{auditblock}{Audit of Block G.1}
\begin{itemize}
...
K_{ir}(y) = K_{-ir}(y),
\]
ensuring parity symmetry. Their asymptotics are recorded in \cref{appG:identities}.
...
\begin{auditblock}{Audit of Block G.2}
\begin{itemize}
...
\begin{auditblock}{Audit of Block G.3}
\begin{itemize}
...
\begin{auditblock}{Audit of Block G.4}
\begin{itemize}
...
\begin{auditblock}{Audit of Block G.5}
\begin{itemize}
