...
\begin{definition}[Error Budget Categories]\label{def:error-budget}
...
\begin{proposition}[Error Budget Bound]\label{prop:error-bound}
...
\begin{remark}[Spectral Harmonization]
