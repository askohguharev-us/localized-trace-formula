...
\input{sections/05-microlocal}  % <-- теперь безопасная заглушка
\input{sections/06-geometric}   % <-- безопасная заглушка
...
% \input{appendices/B-archaios}  % ← убрать/закомментировать
