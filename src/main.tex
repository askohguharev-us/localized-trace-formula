...
% ---------- PDF metadata ----------
\pdfinfo{
  /Title (A Localized Trace Formula for Block 0 — v0.7.0)
...
% \thanks{DOI: \href{https://doi.org/10.5281/zenodo.16813138}{10.5281/zenodo.16813138}}
...
% Unified epsilon-exponent macro (use this in the text)
...
% === Block 0 sections (included from files) ===
\input{sections/01-intro}          % <-- в Contributions используем \EpsDef
\input{sections/02-preliminaries}  %     и в §3 правим ссылку: Lemma 5 -> Lemma 3.1
\input{sections/03-kernel}
\input{sections/04-projector}
\input{sections/05-microlocal}     % полноц. текст (не placeholder)
\input{sections/06-geometric}      % полноц. текст (не placeholder)
...
% \input{appendices/B-archaios}  % keep ancillary metrics outside the main PDF
